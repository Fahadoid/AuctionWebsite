...
MIDDLEWARE = [
    ...
    "project.middleware.rest_middleware",
]
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, "vite-build")]
...
# Trusted CSRF origins, required for hosting on OpenShift
CSRF_TRUSTED_ORIGINS = ["https://*.qmul.ac.uk", "http://localhost:5173"]
...
# Setting to skip sending emails
PRINT_EMAILS = os.getenv("PRINT_EMAILS", "False").lower().strip() not in ("false", "0")
